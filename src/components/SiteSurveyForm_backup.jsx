...
const SiteSurveyForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const message = `Site Survey Request:
Project Description: ${formData.projectDescription}
Survey Cost: ${formData.location ? `KES ${surveyCosts[formData.location]?.toLocaleString() || 'Contact for pricing'}` : 'N/A'}`;
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for your site survey request. We'll contact you within 24 hours to confirm the details and schedule your survey.
          </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Site Survey Request</h1>
          <p className="text-lg text-gray-600">
            Get a professional site assessment for your landscaping project
          </p>
        </div>
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8">
            <div className="space-y-6">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Site Survey Request</h2>
                ...
                >
                  ...
                  {Object.keys(surveyCosts).map(location => (
                    <option key={location} value={location}>
                      {location} (KES {surveyCosts[location].toLocaleString()})
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe your landscaping project and what you'd like us to assess during the site survey"
                />
            ...
            {/* Navigation Buttons */}
            <div className="flex flex-col sm:flex-row justify-center items-center mt-8 pt-6 border-t border-gray-200 gap-4">
              <button
                type="button"
                onClick={openWhatsApp}
