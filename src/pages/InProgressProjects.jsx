...
const inProgressProjects = [
  { title: "Car Parking Shade", image: carShadeImg, location: "Westlands, Nairobi" },
    ...
    <section className="bg-gray-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto">
          <h1 className="text-5xl font-extrabold">Projects In Progress</h1>
          <p className="mt-4 text-xl opacity-90">
            Ongoing installations and builds — track our current work.
          </p>
        </div>
      </div>
